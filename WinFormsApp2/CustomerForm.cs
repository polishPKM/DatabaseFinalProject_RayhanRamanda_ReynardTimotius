...
namespace InventoryManagementSystem
{
    public partial class CustomerForm : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            moduleForm.btnCustSave.Enabled = true;
            moduleForm.btnCustUpd.Enabled = false;
        ...
        private void dgvCustomer_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Edit")
            {
                ...
                customerModule.lbcstid.Text = dgvCustomer.Rows[e.RowIndex].Cells[0].Value.ToString();
                customerModule.textCname.Text = dgvCustomer.Rows[e.RowIndex].Cells[1].Value.ToString();
                customerModule.textCphone.Text = dgvCustomer.Rows[e.RowIndex].Cells[2].Value.ToString();

                customerModule.btnCustSave.Enabled = false;
                customerModule.btnCustUpd.Enabled = true;
